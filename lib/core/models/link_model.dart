...
class LinkModel {
  ...
  static String generateUrl(
      LinkModel linkModel, String regi, String roll, String year) {
  ...
  static Future<List<LinkModel>> loadFromFirebase() async {
    final snapshot = await FirebaseFirestore.instance.collection('links').get();
    return snapshot.docs.map((doc) => LinkModel.fromJson(doc.data())).toList();
  }

  //Make a static saveToFirebase method
  static Future<void> saveToFirebase(LinkModel linkModel) async {
