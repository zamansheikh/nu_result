  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      final linkModel = LinkModel(
        ...
        subbaseUrl: _subbaseUrlController.text,
        regi: _regiController.text,
        roll: _rollController.text,
        year: _yearController.text,
        exp1: _exp1Controller.text,
        sbase1: _sbase1Controller.text,
        regi1: _regiController1.text,
        roll1: _rollController1.text,
        year1: _yearController1.text,
        exp2: _exp2Controller.text,
        sbase2: _sbase2Controller.text,
        regi2: _regiController2.text,
        roll2: _rollController2.text,
        year2: _yearController2.text,
        exp3: _exp3Controller.text,
        sbase3: _sbase3Controller.text,
        regi3: _regiController3.text,
        roll3: _rollController3.text,
        year3: _yearController3.text,
        exp4: _exp4Controller.text,
        sbase4: _sbase4Controller.text,
      );
      // Save the form data to the firestore
