...
import 'package:nu_result/features/big/big_card_image_slide.dart';
import 'package:nu_result/features/html_scrapper/pages/input_page.dart';
import 'package:nu_result/features/result/presentation/bloc/examiner_result_bloc.dart';
import 'package:nu_result/features/result/presentation/page/donation_page.dart';
import 'package:nu_result/features/result/presentation/page/notice_model.dart';
import 'package:nu_result/features/result/presentation/page/user_info_page.dart';
import 'package:nu_result/features/update/update_checker.dart';
import 'package:nu_result/features/update/update_constants.dart';
import 'package:nu_result/features/gplay/pages/g_home.dart';
                      ...
                      children: [
                        ...
                        Center(
                          child: SizedBox(
                            ...
                            height: 50,
                            child: BlocBuilder<ExaminerResultBloc,
                                ExaminerResultState>(
                              builder: (context, state) {
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const GHomePage(),
                ),
              );
            },
          ),
          ...
          ListTile(
            ...
            title: Text(CURRENT_VERSION == _currentVersion
                ? 'Up to date'
                : _currentVersion),
            onTap: () {
